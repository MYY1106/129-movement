...
const Map: FC<fnProps> = ({ changeAct }) => {
    ...
    return (<div ref={firefather} className={styles["four-bg-map"] + " " + styles["four-bg"]} onClick={readyChange}>
        ...
        <div className={styles["four-fire2"]} onTouchStart={startMove} onTouchEnd={cancelMove} />
